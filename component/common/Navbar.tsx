...
import { faSignInAlt, faSignOutAlt, faHome, faUserPlus, faEnvelope } from '@fortawesome/free-solid-svg-icons';
...
const Navbar: FC = () => {
    ...
    const getLoggedInLink = () => {
        return <>
            ...
            <li><Link href="/emails"><a><span><FontAwesomeIcon icon={faEnvelope} /></span>Email</a></Link></li>
